...
# WANDB_PREFIX="UNFUSED-CORRECTED_BETA-FINAL-ECO-0M-ROOH-TAU=${W_QUANT_KWARGS}-LR=${LR}-BETA1=${BETA1}-BETA2=${BETA2}-${RUN_ID}"
WANDB_PREFIX="FP-ECO0-LR=${LR}-BETA1=${BETA1}-${RUN_ID}"
