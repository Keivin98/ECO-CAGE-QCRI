...
def parse_args(base_parser, args, namespace):
    ...
    parser.add_argument("--eval-seq-prefix", default="none", type=str)  # prefix used to generate sequences
    parser.add_argument("--log-dynamics", action="store_true")
    parser.add_argument("--dynamics-logger-cfg", default="./src/logger/rotational_logger.yaml", type=str)
    ...
    parser.add_argument("--carry-decay", default=1.0, type=float)

    # CAGE post-step correction (optional)
    parser.add_argument("--use-cage", type=str2bool, default=False)
    parser.add_argument("--cage-lambda", default=0.1, type=float)
    parser.add_argument("--cage-silence-ratio", default=0.9, type=float)
    parser.add_argument("--cage-schedule", default="linear_ramp", choices=["linear_ramp", "constant"], type=str)
    parser.add_argument("--cage-track-stats", type=str2bool, default=False)
    parser.add_argument("--cage-verbose", type=str2bool, default=False)
    ...
    parser.add_argument(
        "--n-embd",
        default=768,
        type=int,  # embedding size / hidden size ...
    )
    parser.add_argument(
    ...
    # Quantization
    parser.add_argument("--w-quant", type=str, default="NoQuantizer", choices=QUANTIZER_CLASSES.keys())
    parser.add_argument(
        "--w-quant-kwargs",
        type=json.loads,
        default="{}",
    )
    parser.add_argument("--a-quant", type=str, default="NoQuantizer", choices=QUANTIZER_CLASSES.keys())
    parser.add_argument(
        "--a-quant-kwargs",
        type=json.loads,
        default="{}",
