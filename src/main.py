...
def main(args):
    ...
    # Add numpy to torch safe serialization globals to allow safe pickling and unpickling
    ...
    if distributed_backend.is_master_process() and args.wandb:
        ...
        wandb.define_metric("lr/*", step_metric="iter")
        wandb.define_metric("train/update_norm/*", step_metric="iter")
        wandb.define_metric("train/carry_norm/*", step_metric="iter")
    ...
    print("I AM USING THIS OPTIMIZER", args.opt.lower(), args.opt.lower() == "adamw", args.opt.lower() == "qcriadamw",args.opt.lower() == "qcriadamwgradaccumulator",  args.opt.lower() == "naive", args.opt.lower() == "sfadamw")
    ...
    elif args.opt.lower() == "qcriadamwgradaccumulator":
        opt = QCRIAdamWGradAccumulator(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
            weight_decay=args.weight_decay,
    ...
    elif args.opt.lower() == "qcridamwternary":
        opt = QCRIAdamWTernary(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
            weight_decay=args.weight_decay,
    ...
    elif args.opt.lower() == "qcriadamwternarystep2":
        opt = QCRIAdamWTernaryStep2(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
            weight_decay=args.weight_decay,
    ...
    elif args.opt.lower() == "qcriecoadam":
        opt = QCRIECOAdam(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2)
        )
    elif args.opt.lower() == "qcriternarycarryadam":
        opt = QCRITernaryCarryAdam(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
            tau=args.tau,
    ...
    elif args.opt.lower() == "qcriternaryadam":
        opt = QCRITernaryAdam(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
    ...
    elif args.opt.lower() == "eco":
        opt = ECOAdam(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
        )
    elif args.opt.lower() == "ecohm":
        opt = ECOAdamHM(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
        )
    elif args.opt.lower() == "eco0m":
        opt = ECOAdam0M(
            group_specs,
            lr=args.lr,
            betas=(args.beta1, args.beta2),
        )
    elif args.opt.lower() == "eco0m-rooh":
        print("optim: Adam0Rooh")
        opt = Adam0Rooh(
