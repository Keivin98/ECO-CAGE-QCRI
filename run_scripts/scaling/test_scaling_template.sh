#!/bin/bash -l
#SBATCH -J scaling_MODELSIZE
#SBATCH -o outs/scaling_MODELSIZE_%A_%a.out
#SBATCH -e outs/scaling_MODELSIZE_%A_%a.err
#SBATCH -p gpu-H200
...
# Scaling experiment template
# Usage: Copy and modify for each model size (100M, 300M, 1B)
...
# ========================================
# MODEL SIZE CONFIGURATION - EDIT THIS!
# ========================================

# Example for 100M model:
MODEL_SIZE="100M"
export N_LAYER=8
export N_EMBD=1024
export N_HEAD=8

# Batch config (adjust for memory)
export BATCH_SIZE=32      # Reduce for larger models
export ACC_STEPS=16       # Increase for larger models
