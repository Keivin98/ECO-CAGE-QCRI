...
bash train_no_activations.sh \
    ...
    --a-quant=NoQuantizer \
    --carry-decay=0.25 \
    --w-quant-kwargs='{"bits":4,"tau":0.01}' \
    --a-quant-kwargs='{"bits":4,"calibrate_once":true,"tau":0.01}'
...
bash train_no_activations.sh \
    ...
    --a-quant=NoQuantizer \
    --carry-decay=0.25 \
    --w-quant-kwargs='{"bits":4,"tau":0.05}' \
    --a-quant-kwargs='{"bits":4,"calibrate_once":true,"tau":0.05}'
...
bash train_no_activations.sh \
    ...
    --a-quant=NoQuantizer \
    --carry-decay=0.25 \
    --w-quant-kwargs='{"bits":4,"tau":0.1}' \
    --a-quant-kwargs='{"bits":4,"calibrate_once":true,"tau":0.1}'