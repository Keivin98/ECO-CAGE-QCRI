...
echo "  static-eco0 (constant LR after warmup) should match/beat cos (decay to LR/10)"
...
echo "  1. Compare validation loss: cos vs static-eco0 at each (LR, QUANT_MODE)"
echo "  2. If static-eco0 wins/ties → validates constant LR hypothesis"
